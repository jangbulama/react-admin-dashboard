...
//       try {
//         setLoading(true);
//         const response = await fetch("http://localhost:4000/api/package/trekking-packages");
...
//         response = await fetch(`http://localhost:4000/api/package/trekking-packages/${editId}`, {
//           method: 'PUT',
//           headers: {
...
//       } else {
//         // Add new package
//         response = await fetch('http://localhost:4000/api/package/trekking-packages', {
//           method: 'POST',
//           headers: {
//             'Content-Type': 'application/json',
//           },
...
//       const refreshResponse = await fetch("http://localhost:4000/api/package/trekking-packages");
//       const updatedData = await refreshResponse.json();
      
//       if (updatedData.success && Array.isArray(updatedData.packages)) {
//         setPackages(updatedData.packages);
//         setFilteredPackages(updatedData.packages);
//       } else {
//         throw new Error("Invalid data format received from API");
//       }
...
//       setError("Failed to save trekking package. Please try again later.");
//     }
...
//     try {
//       const response = await fetch(`http://localhost:4000/api/package/trekking-packages/${id}`, {
//         method: 'DELETE',
//       });
...
//       }
//     } catch (err) {
//       console.error("Error deleting trekking package:", err);
//       setError("Failed to delete trekking package. Please try again later.");
//     }
//   };
...
//                 <th className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Days Required</th>
//                 <th className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Rating</th>
//                 <th className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Difficulty Level</th>
...
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">{pkg.rating.toFixed(1)}</td>
...
//       } else {
//         // Add new package using the correct endpoint
//         await axios.post('http://localhost:4000/api/package/add-trekking-package', newPackage);
//       }
...
//     } catch (err) {
//       console.error("Error saving trekking package:", err);
//       setError(err.response?.data?.message || "Failed to save trekking package. Please try again later.");
//     }
...
//   const handleDelete = async (id) => {
//     try {
//       await axios.delete(`http://localhost:4000/api/package/trekking-packages/${id}`);
...
//     } catch (err) {
//       console.error("Error deleting trekking package:", err);
//       setError(err.response?.data?.message || "Failed to delete trekking package. Please try again later.");
//     }
//   };
